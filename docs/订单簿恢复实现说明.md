...
| [validation.rs](../src/production/validation.rs)、[phases.rs](../src/production/validation/phases.rs)、[report.rs](../src/production/validation/report.rs)、[close_range.rs](../src/production/validation/close_range.rs) | 有效参考选帧、独立审计、候选、收盘比较视图和 v2 报告 |
